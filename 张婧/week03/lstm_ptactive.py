...
#机器学习/深度学习/LLM的输入是文本，需要文本编码或预处理
...
class CharLSTMDataset(Dataset):
    ...
    def __init__(self, texts, labels, char_to_index, max_len):
        ...
        self.max_len = max_len  # 文本最大度输入长度
...
class LSTMClassifier(nn.Module):
    ...
    def forward(self, x):
        ...
        # 取最后一层的隐藏状态
        # hidden_state形状: (num_layers, batch_size, hidden_dim)
